...
/******/ 	deferredModules.push(["./charts/components/highcharts/line.js","highcharts"]);
...
/***/ "./charts/components/highcharts/base.js":
/*!**********************************************!*\
  !*** ./charts/components/highcharts/base.js ***!
  \**********************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _base__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./base */ \"./charts/components/highcharts/base.js\");\n\n\n//hicharts只是一个用例，说明可以支持多图表库，这里不做代码封装\nObject(_base__WEBPACK_IMPORTED_MODULE_0__[\"onMessage\"])(e => {\n\tconsole.log(e);\n\tconst { option } = e.data;\n\tObject(_base__WEBPACK_IMPORTED_MODULE_0__[\"createChart\"])(option);\n});\n\n//# sourceURL=webpack:///./charts/components/highcharts/line.js?");
