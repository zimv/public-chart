...
/******/ 	deferredModules.push(["./charts/components/antv/line.js","@antv/g2"]);
...
/***/ "./charts/components/antv/base.js":
/*!****************************************!*\
  !*** ./charts/components/antv/base.js ***!
  \****************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _base__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./base */ \"./charts/components/antv/base.js\");\n\nconsole.log('000');\n//hicharts只是一个用例，说明可以支持多图表库，这里不做代码封装\nObject(_base__WEBPACK_IMPORTED_MODULE_0__[\"onMessage\"])(e => {\n\tconsole.log(e);\n\tconst { \n\t\tposition,\n\t\tdata,\n\t\twidth,\n\t\theight \n\t} = e.data;\n\tObject(_base__WEBPACK_IMPORTED_MODULE_0__[\"createChart\"])({\n\t\tposition,\n\t\tdata,\n\t\twidth,\n\t\theight\n\t});\n});\n\n//# sourceURL=webpack:///./charts/components/antv/line.js?");
